#ifndef LIMO_NAV2_PLANNERS__ASTAR_PLANNER_HPP_
#define LIMO_NAV2_PLANNERS__ASTAR_PLANNER_HPP_
...
/**
 * @brief Esqueleto de um planner global A* para o Nav2.
 *
...
#endif  // LIMO_NAV2_PLANNERS__ASTAR_PLANNER_HPP_
